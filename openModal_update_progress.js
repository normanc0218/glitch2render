  ...
  "blocks": [
    {
      ...
      "element": {
        ...
        "options": [
          {
            "text": { "type": "plain_text", "text": "Fai", "emoji": true },
            "value": "value-0"
          },
          {
            "text": { "type": "plain_text", "text": "Steven", "emoji": true },
            "value": "value-1"
          },
          {
            "text": { "type": "plain_text", "text": "Sam", "emoji": true },
            "value": "value-2"
          }
        ],
        "action_id": "whoupdate"
    ...
    },
    {
      ...
      "accessory": {
        "type": "checkboxes",
        "options": [
          { "text": { "type": "mrkdwn", "text": "Wear or Tear" }, "value": "value-0" },
          { "text": { "type": "mrkdwn", "text": "Operator error" }, "value": "value-1" },
          { "text": { "type": "mrkdwn", "text": "No issue" }, "value": "value-2" },
          { "text": { "type": "mrkdwn", "text": "Unknown issue" }, "value": "value-3" },
          { "text": { "type": "mrkdwn", "text": "Other" }, "value": "value-4" }
        ],
    ...
    },
    {
      ...
      "accessory": {
        ...
        "options": [
          {
            "text": { "type": "mrkdwn", "text": "Complete the job and Fixed the issue" },
            "value": "complete"
          },
          {
            "text": { "type": "mrkdwn", "text": "Report other job status (Please select from below)" },
            "value": "value-4"
          }
        ],
    ...
    },
    {
      ...
      "element": {
        ...
        "options": [
          {
            "text": { "type": "mrkdwn", "text": "Waiting for parts" },
            "value": "wait4part"
          },
          {
            "text": { "type": "mrkdwn", "text": "Follow-up check" },
            "value": "fcheck"
          },
          {
            "text": { "type": "mrkdwn", "text": "Temporarily fixed" },
            "value": "temporarilyfixed"
          },
          {
            "text": { "type": "mrkdwn", "text": "Other" },
            "value": "other"
          }
        ],
